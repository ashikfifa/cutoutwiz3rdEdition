...
<div class="col-md-6"style={{marginTop:"8%"}}>
                <p style={{fontSize:"34px",fontWeight:"500",fontFamily:"Poppins"}}>Hacemos</p>
                 ...
                 <p style={{fontSize:"38px",fontWeight:"700",marginTop:"-33px"}}>Imagen y Vídeo</p>
                <p style={{fontSize:"38px",fontWeight:"700",marginTop:"-30px"}}>
                <Typical
                    steps={['Edición', 1000, 'Corrección de color', 500, 'Retoque', 500, 'Automatización', 500]}
                    loop={Infinity}
                    wrapper="p"
                />               
                </p>
                ...
                <p style={{fontWeight:"500",fontFamily:"Poppins"}}>Tu one-stop<br/>
                 solución de postproducción de contenidos</p>
                ...
                <Link target="_blank" to="/es/contact-us" ><button type="button" id="button2">COTIZACIÓN GRATIS</button></Link>
                </div>
      ...
      <div class="row">
          ...
          <div class="card" style={{width: "100%",borderRadius:"10px"}}>
              ...
              <div class="card-body"style={{marginTop:"-3%"}}>
                ...
                <p class="card-text"style={{marginTop:"-7%",fontWeight:"500"}}>Imágenes<br/>Procesadas Diar..</p>
              </div>
              </div>
          </div>
          ...
          <div class="card" style={{borderRadius:"10px",width: "100%"}}>
              ...
              <div class="card-body"style={{marginTop:"-3%"}}>
                ...
                <hr style={{width:"32%",border:"1px solid",backgroundColor:"black",opacity:"1",marginTop:"-1%"}}></hr>
                <p class="card-text"style={{marginTop:"-7%",fontWeight:"500"}}>Más De Imágenes <br/>De Prueba Gratuitas</p>
              </div>
              </div>
              </div>
          </div>
...
<div class="container" id="imageses">
    ...
    <p style={{textAlign:"center",fontFamily:"poppins",fontSize:"20px",fontWeight:"100"}}>Imagen Edición Servicios</p><br/><br/>
    ...
    <div class="row"style={{marginTop:"-3%"}}>
      ...
      <BeforeAfterSlider
          ...
          height={200}
        />
        <p style={{fontWeight:"700",textAlign:"center"}}>Eliminación de fondo</p>
      </div>
      ...
      <BeforeAfterSlider
          ...
          height={200}
        />
        <p style={{fontWeight:"700",textAlign:"center"}}>Creación de sombras</p>
      </div>
    ...
    <div class="row">
      ...
      <BeforeAfterSlider
          ...
          height={200}
        />
        <p style={{fontWeight:"700",textAlign:"center"}}>Maniquí fantasma</p>
      </div>
      ...
      <BeforeAfterSlider
          ...
          height={200}
        />
        <p style={{fontWeight:"700",textAlign:"center"}}>Corrección de color</p>
      </div>
      ...
      <BeforeAfterSlider
          ...
          height={200}
        />
        <p style={{fontWeight:"700",textAlign:"center"}}>Manipulación de imagen</p>
      </div>
    </div>
    <br/><br/>
    </div>
...
<div style={{backgroundColor:"#f3f5f7"}}>
  <br/>
    ...
    <h1 style={{textAlign:"center",fontFamily:"poppins",fontWeight:"700"}}>Servicios</h1>
    <p style={{textAlign:"center",fontFamily:"poppins",fontSize:"20px",fontWeight:"100"}}>Vídeos edición Servicios</p><br/><br/>
    ...
    <div class="row"style={{marginTop:"-5%"}}>
      ...
      <p style={{textAlign:"center"}}>Servicio de edición de audio</p>
      </div>
    ...
    <div class="row">
      ...
      <p style={{textAlign:"center"}}>Servicio de adicción a los subtítulos</p>
      </div>
      ...
      <p style={{textAlign:"center"}}>Servicio de adición de títulos</p>
      </div>
    </div>
<br/><br/><br/><br/>
</div>
  ...
  <div class="container"id="appses"style={{marginTop:"4%"}}>
    ...
    <p style={{textAlign:"center",marginTop:"-1%",fontSize:"20px"}}>Nuestras aplicaciones aparecen en las principales plataformas de comercio electrónico</p><br/><br/>
...
than here. But remember you get what you pay but remember</p>
    ...
    <div class="row">
      ...
      <p style={{textAlign: "justify"}}>Ofrecemos múltiples opciones de precios para que usted elija para ayudarlo a alcanzar sus objetivos. Elige el que mejor se adapte a tus necesidades. En caso de que esté buscando algo más, o desee un presupuesto nuestro para cualquier tipo de personalización, no dude en enviarnos un mensaje de texto a través de nuestro formulario de contacto.</p>
  ...
  <div class="containerp">
      <div class="column">
        <div class="pricing-card basic">
          <div class="pricing-header">
            <span class="plan-title">Plan Básico</span>
          ...
          <ul>
            ...
            <li>
              <strong>1-100</strong> IMÁGENES/PEDIDO
            </li>
            <li>
              <strong>10 </strong> IMÁGENES-GRATIS
            </li>
            <li>
              <strong>1</strong> MESE DE ALMACENAMIENTO
            </li>
            <li>
              <strong>24/7</strong> ATENCIÓN AL CLIENTE
            </li>
          </ul>
      ...
      <div class="column">
        <div class="pricing-card echo">
          <div class="pricing-header">
            <span class="plan-title">Estándar</span>
            <div class="price-circle">
            <span class="info" style={{paddingTop: "22%",fontSize: "14px",color: "black"}}>Desde</span>
              <span class="price-title" style={{marginTop: "-29%"}}>
          ...
          <div class="pricing-header">
            ...
            <div class="price-circle">
              <span class="price-title">
               <span style={{fontSize:"21px"}}> <strong>Contácten </strong></span>
...
<div class="container"id="howitworkses">
    <h1 style={{textAlign:"center"}}>¿Cómo puedes hacer un pedido?</h1>

    <p style={{textAlign:"center",marginTop:"-1%",fontSize:"20px"}}>Simplemente siga estas sencillas instrucciones y le ayudaremos con todo lo demás.</p> 

    <div class="row">
      <div class="col-md-6" style={{marginTop:"3%"}}>
        <p>
       <b> Paso 1: </b><br/>
           Inicie sesión para comenzar <br/>
          <b> Paso 2: </b><br/>
          Elija su plan de suscripción preferido<br/>
          <b> Paso 3: </b><br/>
          Vaya a su cuenta para hacer un pedido<br/>
          <b> Paso 4: </b><br/>
          Upload las imágenes que quieras que editemos<br/>
          <b> Paso 5: </b><br/>
          Procesaremos las imágenes por usted.<br/>
          <b> Paso 6: </b><br/>
          Descarga las imágenes editadas
        </p>
      </div>
      <div class="col-md-6">
...
<div class="containerback"id="contactus">
  ...
  <div class="centered">
  <h2>Estamos aquí para<br/><span style={{fontWeight:"600"}}>responder a todas sus consultas</span><br/></h2>
...
<p style={{textAlign:"center",marginTop:"-0.5%",fontSize:"20px"}}>Quiénes somos y cómo llegamos a ser</p> 
...
<p style={{textAlign:"justify"}}>CutOutWiz es una de las principales empresas de edición de imágenes y videos para empresas de todo el mundo. A medida que el mundo avanza hacia un futuro virtual, con la edición de fotografías de productos en línea cada vez más accesible, las imágenes de productos en HD son lo que esencialmente impulsa las ventas. Somos el socio de edición de imágenes en línea de confianza para muchas empresas de comercio electrónico de renombre en todo el mundo en una amplia gama de industrias. Ofrecemos todos los servicios posibles de edición (procesamiento) de imágenes, desde servicios de uso común como eliminación de imágenes de fondo, corrección de color, retoque de imágenes, maniquí invisible, hasta servicios complejos como manipulación de imágenes. La razón detrás de nuestro éxito es que creemos en el cliente primero y brindamos un servicio de la mejor calidad.</p>
  ...
  <div class="footer"style={{backgroundColor:"#231f20"}}>
    ...
    <p style={{textAlign:"justify",color:"#b7b9bb",marginTop:"4%"}}>CutOutWiz es una de las principales empresas de edición de imágenes y videos para empresas de todo el mundo.</p>
    ...
    <a href="https://www.instagram.com/accounts/login/"target="_blank" class="fa fa-instagram"></a>
        ...
        <div class="col-6 col-md-2"style={{marginTop:"5%"}}>
            <b style={{color:"white",fontSize:"20px"}}>Menú</b>

            <p style={{color:"#b7b9bb",marginTop:"8%"}}>
         <Link to="/" target="_blank"  style={{textDecoration:"none",color:"#b7b9bb"}}> Home</Link> <br/>
         <Link to="#apps" target="_blank"  style={{textDecoration:"none",color:"#b7b9bb"}}> Características</Link><br/>
        ...
        <div class="col-6 col-md-2"style={{marginTop:"5%"}}>
        <b style={{color:"white",fontSize:"20px"}}>Características</b>
        ...
        <div class="col-6 col-md-2"style={{marginTop:"5%"}}>
        <b style={{color:"white",fontSize:"20px"}}>Enlaces útiles</b>

          <p style={{color:"white",marginTop:"8%"}}>
         <Link to="/privacy-policy" target="_blank"style={{textDecoration:"none",color:"#b7b9bb"}}> Política de privacidad </Link> <br/>
         <Link to="/terms-and-conditions" target="_blank"style={{textDecoration:"none",color:"#b7b9bb"}}> Términos y Condiciones</Link><br/>
      ...
      <b style={{color:"white",fontSize:"20px"}}>Nuestra dirección</b> <br/>   <br/>
    ...
    <p style={{textAlign:"center",color:"white",padding:"8px",backgroundColor:"black"}}>Diseñado y desarrollado por <Link to="/" target="_blank"  style={{textDecoration:"none",color:"white"}}>CutOutWiz</Link></p>
